...
var payUI_1 = require("./utils/payUI");
...
function PayProvider(_a) {
            ...
            return __generator(this, function (_d) {
                ...
                if (rawQRData.substring(0, 7) === 'solana:') {
                    try {
                        ...
                        if (!(0, helperFunctions_1.isTransferRequestURL)(payParams))
                            return [2 /*return*/];
                        dispatch({
                            type: 'decode',
                ...
                if (rawQRData.toUpperCase().includes('PAYNOW') ||
                    ...
                    _a = (0, helperFunctions_1.extractPayNowInfo)(rawQRData), uen = _a.uen, phoneNumber = _a.phoneNumber, netsAccount = _a.netsAccount;
                    ...
                    case 1:
                        ...
                        for (i = 0; i < (transactions === null || transactions === void 0 ? void 0 : transactions.length); i++) {
                            ...
                            for (j = 0; j < instructions.length; j++) {
                                ...
                                if (!(0, helperFunctions_1.isParsedInstruction)(instruction))
                                    continue;
    ...
    function constructMemoWithEncryption(description, apiKey) {
        ...
        return MemoPrefix + (0, helperFunctions_1.encrypt)(JSON.stringify(memoInfo), apiKey);
    }
    function destructureMemoWithDecryption(memo, apiKey) {
        try {
            ...
            var memoInfo = JSON.parse((0, helperFunctions_1.decrypt)(memo.substring(5), apiKey));
    ...
    return (react_1.default.createElement(PayContext.Provider, { value: __assign(__assign({}, state), { pay: pay, decode: decode, reset: reset, updateFields: updateFields, getPaymentTransactions: getPaymentTransactions }) }, children));
}
function usePay() {
...
function PayUI(_a) {
    ...
    switch (payCrypto.payType) {
        case 'SOLANA_ADDRESS':
            return react_1.default.createElement(payUI_1.PayThroughSolanaTransfer, { payCrypto: payCrypto });
        case 'SOLANA_PAY':
            return react_1.default.createElement(payUI_1.PayThroughSolana_Pay, { payCrypto: payCrypto });
        case 'RIPE_FIAT':
            return react_1.default.createElement(payUI_1.PayThroughRipeFiat, { payCrypto: payCrypto });
        case null:
            return react_1.default.createElement(payUI_1.QRScanner, { decode: payCrypto.decode });
        default:
            return react_1.default.createElement(payUI_1.QRScanner, { decode: payCrypto.decode });
    }
}
