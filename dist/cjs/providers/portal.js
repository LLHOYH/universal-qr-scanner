...
exports.usePortal = exports.PortalProvider = void 0;
/* eslint-disable no-unsafe-finally */
/* eslint-disable @typescript-eslint/no-unused-vars */
var React = __importStar(require("react"));
var react_1 = require("react");
var web_1 = __importDefault(require("@portal-hq/web"));
var web3_js_1 = require("@solana/web3.js");
var pyusdThumb = '/pyusd.png';
var solanaThumb = '/solana.png';
var PortalContext = (0, react_1.createContext)({});
var PortalProvider = function (_a) {
    var children = _a.children;
    var SOLANA_MEMO_PROGRAM_ID = 'MemoSq4gqABAXKb96qnH8TysNcWxMyWCqXgDLGmfcHr';
    var _b = (0, react_1.useState)(), portal = _b[0], setPortal = _b[1];
    (0, react_1.useEffect)(function () {
        var _a;
        setPortal(new web_1.default({
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 2:
                                ...
                                memoInstruction = new web3_js_1.TransactionInstruction({
                                    keys: [],
                                    programId: new web3_js_1.PublicKey(SOLANA_MEMO_PROGRAM_ID),
                        ...
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                if (!process.env.solanaRpcUrl || !address)
                                    return [2 /*return*/];
                                connection = new web3_js_1.Connection(process.env.solanaRpcUrl);
...
var usePortal = function () { return (0, react_1.useContext)(PortalContext); };
