...
exports.extractPayNowInfo = extractPayNowInfo;
exports.isTransferRequestURL = isTransferRequestURL;
...
function encrypt(data, apiKey) {
    ...
    var key = crypto_1.default.createHash('sha256').update(apiKey).digest();
